...
**Features**:
- ✅ Detects all orphaned `.sql` files
- ✅ Preview mode (`--dry-run`) for safe testing
- ✅ Auto-fix with file preservation
- ✅ JSON output for programmatic access
- ✅ Detailed error reporting
- ✅ Safe file operations (atomic renames)
...
- ✅ Full linting compliance (ruff, clippy)
...
❌ NOT RECOGNIZED (will be silently ignored):
...
- ✅ File scanning is <1ms for typical projects
- ✅ Auto-fix is instantaneous (file renames)
- ✅ Optional: warnings only show when issues detected
...
- [Full Changelog](https://github.com/fraiseql/confiture/blob/main/CHANGELOG.md)
