...
- name: Check for unsafe migrations
  run: |
    ...
    if [ "$UNSAFE" -gt 0 ]; then
      echo "❌ Found $UNSAFE unsafe migrations"
      exit 1
    fi
```
...
- **Documentation**: [docs/guides/cli-dry-run.md](../guides/dry-run.md)
- **Architecture**: [ARCHITECTURE.md](https://github.com/fraiseql/confiture/blob/main/ARCHITECTURE.md)
- **Development**: [DEVELOPMENT.md](../development.md)
- **Full Changelog**: [CHANGELOG.md](https://github.com/fraiseql/confiture/blob/main/CHANGELOG.md)
