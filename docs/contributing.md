...
- **New features** - Pick up an item from the [issue tracker](https://github.com/fraiseql/confiture/issues)
...
[Lockfile Bump](https://github.com/fraiseql/confiture/blob/main/.github/workflows/lockfile-bump.yml) workflow proposes them
...
See [examples/README.md](https://github.com/fraiseql/confiture/blob/main/examples/README.md) for structure.
...
1. **Check the roadmap** ([open issues](https://github.com/fraiseql/confiture/issues) and [CHANGELOG.md](https://github.com/fraiseql/confiture/blob/main/CHANGELOG.md))
...
- [ ] Read [CLAUDE.md](https://github.com/fraiseql/confiture/blob/main/CLAUDE.md) for development guide
- [ ] Review the [open issues](https://github.com/fraiseql/confiture/issues) to understand the roadmap
...
- **[CLAUDE.md](https://github.com/fraiseql/confiture/blob/main/CLAUDE.md)** - Development methodology
- **[ARCHITECTURE.md](https://github.com/fraiseql/confiture/blob/main/ARCHITECTURE.md)** - Architecture and design decisions
- **[docs/reference/](https://github.com/fraiseql/confiture/tree/main/docs/reference/)** - API documentation
