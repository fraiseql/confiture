...
1. **Read the Docs**
   - [DATABASE_SETUP.md](guides/database-setup.md) - Detailed setup
   - [DEVELOPMENT.md](development.md) - Development guide
   - [docs/](https://github.com/fraiseql/confiture/tree/main/docs/) - Full documentation

2. **Explore Examples**
   - [examples/](https://github.com/fraiseql/confiture/tree/main/examples/) - 5 production-ready examples
...
4. **Read detailed guide**
   - [DATABASE_SETUP.md](guides/database-setup.md) - Full setup guide
   - [DEVELOPMENT.md](development.md) - Development workflow
   - [Troubleshooting](guides/database-setup.md#troubleshooting) - Common issues
