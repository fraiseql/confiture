...
Multi-agent coordination is a plugin since 1.16, not part of confiture's core. Its CI/CD workflows (pre-merge conflict checks, registering an intention, recording the merge, dashboard export) are in the plugin's documentation: [`plugins/fraiseql-confiture-pggit/docs/ci-integration.md`](https://github.com/fraiseql/confiture/blob/main/plugins/fraiseql-confiture-pggit/docs/ci-integration.md).
