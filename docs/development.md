...
1. **[README.md](https://github.com/fraiseql/confiture/blob/main/README.md)** - Quick overview and features
2. **[ARCHITECTURE.md](https://github.com/fraiseql/confiture/blob/main/ARCHITECTURE.md)** - System design and components
3. **[CLAUDE.md](https://github.com/fraiseql/confiture/blob/main/CLAUDE.md)** - Development standards and philosophy
...
1. **Understand the architecture**: Read [ARCHITECTURE.md](https://github.com/fraiseql/confiture/blob/main/ARCHITECTURE.md)
...
# Check the latest applied version
...
- **Architecture**: [ARCHITECTURE.md](https://github.com/fraiseql/confiture/blob/main/ARCHITECTURE.md)
- **Quick Start**: [README.md](https://github.com/fraiseql/confiture/blob/main/README.md)
- **Standards**: [CLAUDE.md](https://github.com/fraiseql/confiture/blob/main/CLAUDE.md)
- **Guides**: [docs/guides/](https://github.com/fraiseql/confiture/tree/main/docs/guides/)
- **Development History**: [CHANGELOG.md](https://github.com/fraiseql/confiture/blob/main/CHANGELOG.md)

### Questions?

1. Check the [ARCHITECTURE.md](https://github.com/fraiseql/confiture/blob/main/ARCHITECTURE.md) for design decisions
2. Look at [docs/guides/](https://github.com/fraiseql/confiture/tree/main/docs/guides/) for examples
