...
- Every machine-readable CLI output has a published JSON schema, shipped in the package (`python/confiture/schemas/`) and mirrored under [`docs/reference/json-schemas/`](docs/reference/json-schemas/) — see [`docs/reference/json-schemas.md`](docs/reference/json-schemas.md).
