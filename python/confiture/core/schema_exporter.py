    ...
    return {
        ...
        "MigrationInfo": {
            ...
            "properties": {
                ...
                "applied_at": {"anyOf": [{"type": "string", "format": "date-time"}, {"type": "null"}]},
            },
            "additionalProperties": False,
        },
        "StatusResult": {
        ...
        "MigrateUpResult": {
            ...
            "type": "object",
            "required": ["success", "applied", "skipped", "errors", "total_duration_ms",
                         "checksums_verified", "dry_run", "warnings"],
            "properties": {
                "success": {"type": "boolean"},
        ...
        "MigrateDownResult": {
            ...
            "type": "object",
            "required": ["success", "rolled_back", "total_duration_ms",
                         "checksums_verified", "warnings"],
            "properties": {
                "success": {"type": "boolean"},
        ...
        "MigrateRebuildResult": {
            ...
            "type": "object",
            "required": ["success", "schemas_dropped", "ddl_statements_executed",
                         "marked", "total_duration_ms", "dry_run"],
            "properties": {
                "success": {"type": "boolean"},
        ...
        "DriftReport": {
            ...
            "type": "object",
            "required": ["database_name", "expected_schema_source", "has_drift",
                         "has_critical_drift", "critical_count", "warning_count",
                         "info_count", "tables_checked", "columns_checked",
                         "indexes_checked", "detection_time_ms", "drift_items"],
            "properties": {
        ...
        "VerifyAllResult": {
            ...
            "type": "object",
            "required": ["verified_count", "failed_count", "skipped_count",
