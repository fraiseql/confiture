...
from confiture_pggit.client import Branch, Commit, DiffEntry, MergeResult, StatusInfo
from confiture_pggit.detection import get_pggit_info, is_pggit_initialized
...
class TestPgGitDetection:
    ...
    def test_get_pggit_version_parses_version_string(self):
        ...
        with patch("confiture_pggit.detection.is_pggit_available", return_value=True):
    ...
    def test_get_pggit_version_returns_none_when_not_available(self):
        ...
        with patch("confiture_pggit.detection.is_pggit_available", return_value=False):
            result = get_pggit_version(mock_conn)
    ...
    def test_require_pggit_raises_on_version_mismatch(self):
        ...
        with patch("confiture_pggit.detection.is_pggit_available", return_value=True):
            with patch(
                "confiture_pggit.detection.get_pggit_version",
                return_value=(0, 0, 1),
            ):
...
class TestPgGitClientMocked:
    ...
    def test_client_initialization(self):
        ...
        with patch(
            "confiture_pggit.client.require_pggit",
            return_value=(0, 1, 0),
        ):
    ...
    def test_get_pggit_info_when_available(self):
        ...
        with patch("confiture_pggit.detection.is_pggit_available", return_value=True):
            with patch(
                ...
                with patch(
                    "confiture_pggit.detection.is_pggit_initialized",
                    return_value=True,
                ):
