...
Usage:
    from confiture_pggit import PgGitClient, is_pggit_available
...
Example workflow:
    ...
    from confiture_pggit.generator import MigrationGenerator
    generator = MigrationGenerator(conn)
    migrations = generator.generate_from_branch("feature/payments")
"""

from confiture_pggit.client import PgGitClient
...
from confiture_pggit.detection import (
    MIN_PGGIT_VERSION,
    get_pggit_version,
    is_pggit_available,
    require_pggit,
)
from confiture_pggit.exceptions import (
    PgGitBranchError,
    PgGitCheckoutError,
    PgGitError,
...
from confiture_pggit.generator import (
    GeneratedMigration,
    MigrationGenerator,
)
