...
│  ┌──────────────────────────────────────────────────────┐  │
│  │                    CLI Layer                         │  │
│  │  (src/confiture_pggit/cli/coordinate.py)             │  │
│  │                                                       │  │
│  │  Commands:                                            │  │
│  │  • coordinate register                                │  │
...
│  ┌──────────────────────────────────────────────────────┐  │
│  │              Coordination Core                       │  │
│  │  (src/confiture_pggit/coordination/)                 │  │
│  │                                                       │  │
│  │  ┌──────────────┐  ┌──────────────┐  ┌────────────┐ │  │
...
> **📊 Comprehensive Benchmarks**: See [coordination-performance.md](coordination-performance.md) for detailed performance analysis with 18 comprehensive benchmark tests.
...
**Run Benchmarks**:
```bash
# from confiture's repository root
uv run --no-sync pytest plugins/fraiseql-confiture-pggit/tests/performance/test_coordination_benchmarks.py -m benchmark -v -s
```
...
- [User Guide](multi-agent-coordination.md)
- [API Usage](multi-agent-coordination.md#api-usage)
- [Examples](../examples/multi-agent-workflow/README.md)
